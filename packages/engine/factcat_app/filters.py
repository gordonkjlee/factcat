...
CHROME = {
    "plain": {
        ...
        "bd_at_first": "first ever",
        "bd_at_latest": "latest ever",
        ...
        "bd_fill_series": "(this series' events)",
        "bd_fill_group": "Event names",
        "bd_section": "Break down",
        "of": "Of",
        "volume": "Volume",
    ...
    "sql": {
        ...
        "bd_at_range_start": "range start",
        "bd_at_range_end": "range end",
        "bd_at_first": "first non-null ever",
        "bd_at_latest": "last non-null ever",
